'''simple neural net adapted for the nba_stats_data_set by JStasinks'''
...
class Network(object):
    ...
    def forward_feed(self, data_input, a_func): ### can activation function be added dynamically?
        ...
        z1= np.dot(self.W1, data_input) + self.B1 ## dot product of input matrix and weights matrix plus respective biases
    ...
    def test_prediction(self, index, train_data, train_labels, selected_pos, a_func):
