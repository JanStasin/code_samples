'''
This script is used to run permutation testing on the fitting data results from Stasinski et al. 2024.
It loads data, performs permutation testing, and saves the results.
'''
...
# List of values for gcs and y0s
